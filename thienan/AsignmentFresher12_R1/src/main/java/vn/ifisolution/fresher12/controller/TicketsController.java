...
public class TicketsController {
    ...
    public ResponseEntity<?> createTransactionData(@RequestBody Tickets tickets, UriComponentsBuilder ucBuilder) {
		
		ticketsService.save(tickets);
        
        HttpHeaders headers = new HttpHeaders();
        headers.setLocation(ucBuilder.path("/api/tickets/{id}").buildAndExpand(tickets.getTicketNumber()).toUri());
    ...
    public ResponseEntity<?> updateUser(@PathVariable("id") int id, @RequestBody Tickets tickets) {
