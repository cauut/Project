package vn.ifisolution.fresher12.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "vn.ifisolution.fresher12.repositories",
		entityManagerFactoryRef = "entityManagerFactory",
		transactionManagerRef = "transactionManager")
@EnableTransactionManagement
public class JpaConfigAsignment {
...
//					.password(dataSourceProperties.getPassword())
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "vn.ifisolution.fresher12.entity" });
...
//		properties.put("spring.data.cassandra.keyspace-name", environment.getRequiredProperty("spring.data.cassandra.keyspace-name"));
//		properties.put("spring.data.cassandra.contact-points", environment.getRequiredProperty("spring.data.cassandra.contact-points"));
//		properties.put("spring.data.cassandra.port", environment.getRequiredProperty("spring.data.cassandra.port"));
